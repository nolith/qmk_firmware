...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_split_3x5_3(
       ...
       PT_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M, KC_COMM,  KC_DOT, PT_SLSH,
                      ESC_MED, SPC_NAV,  KC_TAB, ENT_SYM, BSP_NUM, DEL_FUN
  ),
 ...
 */
  [LAYER_FUNCTION] = LAYOUT_split_3x5_3(
    ...
    KC_F11,   KC_F4,   KC_F5,   KC_F6, KC_SCRL,  XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT,
